...
### 🚀 Projects
- **삼육대학교 멋쟁이사자처럼 12기 모집 페이지**: 12기 아기사자(부원) 모집을 위한 페이지 – 백엔드 참여
- **W.A.D**: 개발 초보자의한 ChatGpt기반 커뮤니티 사이트 - 2024-1 교내 SW경진대회 못난이사자들팀 백엔드 참여
- **별책부록**: AI 도서 추천 및 독서대 서비스 – 2024 멋쟁이사자처럼 간지톤(연합 해커톤) 상부삼조팀 백엔드참여
