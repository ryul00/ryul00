...
### 🚀 Projects
- **삼육대 멋사 12기 모집 페이지** : 12기 아기사자(부원) 모집을 위한 페이지 – 백엔드 참여
...
- **P-eeting**: 프리랜서 개발자와 기업 간의 프로젝트 매칭 서비스  – 2025-1 영상의학 AI API연동 프로젝트 기반 자바(Java) 풀스택 개발자 과정 1차 프로젝트 프론트엔드 참여
- **삼육대 멋사 13기 모집 페이지** : 13기 아기사자(부원) 모집을 위한 페이지 – 프론트엔드 참여
